...
def output_to_gdrive(on_drive=False, drive_folder='AI/Generated'):
  ...
  config_dictionary = {
    'outdir_txt2img_samples': f'{save_path}/content/drive/MyDrive/pics/outputs/txt2img-images',
    'outdir_img2img_samples': f'{save_path}/content/drive/MyDrive/pics/outputs/img2img-images',
    'outdir_extras_samples': f'{save_path}/content/drive/MyDrive/pics/outputs/extras-images',
    'outdir_txt2img_grids': f'{save_path}/content/drive/MyDrive/pics/outputs/txt2img-grids',
    'outdir_img2img_grids': f'{save_path}/content/drive/MyDrive/pics/outputs/img2img-grids',
    'outdir_save': f'{save_path}/content/drive/MyDrive/pics/outputs/saved',
  }
